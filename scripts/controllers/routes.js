...
page('/books/:book_id/update', (ctx, next) => app.adminView.verify(ctx, next), (ctx, next) => app.adminView.initAdminPage(ctx, next), (ctx) =>  app.bookView.initUpdateFormPage(ctx));
